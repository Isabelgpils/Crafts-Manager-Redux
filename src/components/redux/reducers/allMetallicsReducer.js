...
const allMetallicsReducer = () => {
	return [
		...
		{ type: 'PB', number: 17, patterns: 'Moss Garden', color: 'Water Blue' },
		{ type: 'PB', number: 26, patterns: 'Moss Garden', color: 'Aztec Gold' },
		{ type: 'PB', number: 50, patterns: 'Moss Garden', color: 'Seashell' },
		{ type: 'PB', number: 51, patterns: 'Moss Garden', color: 'Dark Chocolate' },
		{ type: 'PB', number: 204, patterns: 'Moss Garden', color: 'Blue Pearl' },
		{ type: 'SP', number: '018', patterns: 'Moss Garden' },
		...
		{ type: 'PB', number: 36, patterns: 'Rainforest', color: 'Antique Gold' },
		{ type: 'PB', number: 40, patterns: 'Rainforest', color: 'Egytian Gold' },
		{ type: 'PB', number: 56, patterns: 'Rainforest', color: 'Pal Avocado' },
		{ type: 'SP', number: '038', patterns: 'Rainforest' },

		//Seville
		{ type: 'PB', number: 25, patterns: 'Seville', color: 'Old Gold' },
		{ type: 'PB', number: 33, patterns: 'Seville', color: 'Blue' },
		{ type: 'PB', number: 35, patterns: 'Seville', color: 'Dark Gold' },
		{ type: 'PB', number: 47, patterns: 'Seville', color: 'Ice' },
		{ type: 'PB', number: 57, patterns: 'Seville', color: 'Avocado' },
		{ type: 'PB', number: 204, patterns: 'Seville', color: 'Blue Pearl' },
		{ type: 'SP', number: '036', patterns: 'Seville' },
		{ type: 'SP', number: '039', patterns: 'Seville' },
		...
		{ type: 'PB', number: 33, patterns: 'Sparkling Peacock', color: 'Blue' },
		{ type: 'PB', number: 35, patterns: 'Sparkling Peacock', color: 'Dark Gold' },
		{ type: 'PB', number: 38, patterns: 'Sparkling Peacock', color: 'Azure' },
		{ type: 'PB', number: 43, patterns: 'Sparkling Peacock', color: 'Turquoise' },
		{ type: 'PB', number: 52, patterns: 'Sparkling Peacock', color: 'Lighter Green' },
		{ type: 'SP', number: '038', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '039', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '021', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '019', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '064', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '068', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '113', patterns: 'Sparkling Peacock' },
		{ type: 'SP', number: '118', patterns: 'Sparkling Peacock' },

		//Tinctorium
		{ type: 'PB', number: '04', patterns: 'Tinctorium', color: 'Silver' },
		{ type: 'PB', number: '59', patterns: 'Tinctorium', color: 'Ice Pastels' },
		{ type: 'PB', number: '204', patterns: 'Tinctorium', color: 'Blue Pearl' },
...
export default allMetallicsReducer;