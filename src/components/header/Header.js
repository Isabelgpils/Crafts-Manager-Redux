	...
	return (
		<Fragment>
				...
				<nav>
					...
					<div className="nav-wrapper" style={{ backgroundColor: "rgb(56,64,88)" }}>
						...
						<ul className="left hide-on-med-and-down" style={{ marginLeft: "30px" }}>
							...
							<li><a className="dropdown-trigger" href="#!" data-target="dropdown2">Thread
								<i className="material-icons right">arrow_drop_down</i></a></li>
							{/*---Dropdown Trigger PATTERNS--*/}
							<li><a className="dropdown-trigger" href="#!" data-target="dropdown3">Patterns
								<i className="material-icons right">arrow_drop_down</i></a></li>
							<li><Link to="/Beads">Beads </Link></li>
							<li><Link to="/Metallics">Metallics</Link></li>
			...
			<Switch>
				...
				<Route path="/Caron Waterlilies" component={CaronList}>
				</Route>
				<Route path="/Thread Gatherer" component={TGList}>
				</Route>
